...
- Мощность привода  - не менее 20 кВт
- Управление - дистанционное с пульта управления (планшета) - по радиоканалу. Радиус действия - прямая видимость.
- Освещение:
	- типовое, автомобильного типа (фары, габаритные огни, указатели направления поворота, стоп-сигналы, сигнализация заднего хода)
	- проблесковые маячки по периметру комплекса (могут быть совмещены с указателями направления поворота)
